  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('Beautiful recitations of this Surah.',
            style: AppText.latin(
                color: c.textMuted,
                size: 12,
                height: 1.5)),
...
class _ReciterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = colors;
    final part =
        audio.parts.isNotEmpty ? audio.parts.first : 1;
    final fileId = DownloadService.surahReciterAudioId(
        meta.number, reciter.id, part);
...
class ReciterAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = colors;
    final state = AppState.of(context);
    final path = downloadService.photoLocalPath(
        reciter.id, state.appDocsPath);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Icon(Icons.mic_rounded,
          size: size * 0.45, color: c.goldText),
    );
  }
}
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ListenableBuilder(
              listenable: downloadService,
              builder: (context, _) => TeacherAvatar(
                teacher: teacher,
                downloadService: downloadService,
                colors: c,
                size: 44,
            ...
            Container(
              ...
              child: Text('${audio.totalParts} parts',
                  style: AppText.latin(
                      color: c.brand,
                      size: 10,
                      weight: FontWeight.w700)),
