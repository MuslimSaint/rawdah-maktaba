...
/// Default: vertical scroll. User can toggle to horizontal.
...
class _PdfReaderScreenState extends State<PdfReaderScreen> {
  ...
  /// User can toggle to horizontal via button.
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Save',
                style: AppText.latin(
                    color: c.brand, size: 14, weight: FontWeight.w700)),
          ),
        ],
      ),
    );
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        _horizontalMode ? Icons.view_carousel_rounded : Icons.view_day_rounded,
                        ...
                        builder: (context, _) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(9),
                              border: Border.all(
                                color: isMarked ? c.brand.withOpacity(0.5) : c.divider),
                            ),
                            child: Icon(
